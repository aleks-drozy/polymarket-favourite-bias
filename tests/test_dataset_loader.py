...
def test_nothing_silently_dropped():
    ...
    # Exact-count assertions pin the fixture's classification (3 records, 5 exclusions).
    # The threshold value itself (0.999) is pinned separately by the boundary tests
    # below; row 0xbbb222 at [0.001, 0.999] sits exactly on the boundary and would be
    # excluded under any tighter threshold.
