...
Does always betting the market favourite (>50% implied probability) on PolyMarket's resolved binary Yes/No markets beat the platform's costs? Backtested on **2,418** resolved markets ($100k+ volume, April 2023 – January 2025): favourites win **90.6%** of the time but the strategy still loses **0.98%** per dollar staked after fees (bootstrap 95% CI: **−2.46% to +0.49%**). The pre-registered gate (CI lower bound > 0% after fees, and the edge not concentrated in one category/time window) is **NOT PROVEN**. Full methodology, exclusion accounting, and honest verdict in **[WRITEUP.md](WRITEUP.md)**.
